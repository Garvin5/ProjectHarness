...
**Note:** Tell your human partner that Superpowers works much better with access to subagents. The quality of its work will be significantly higher if run on a platform with subagent support (such as Claude Code or Codex). If subagents are available, use ai-dev-harness:subagent-driven-development instead of this skill.
...
3. If on main/master with no worktree: **REQUIRED SUB-SKILL:** Use `ai-dev-harness:using-git-worktrees` to create one
...
- **REQUIRED SUB-SKILL:** Use ai-dev-harness:finishing-a-development-branch
