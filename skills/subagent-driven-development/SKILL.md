...
digraph process {
    ...
    "Use ai-dev-harness:finishing-a-development-branch" [shape=box style=filled fillcolor=lightgreen];
    ...
    "Dispatch final code reviewer subagent for entire implementation" -> "Use ai-dev-harness:finishing-a-development-branch";
}
```
...
- **ai-dev-harness:using-git-worktrees** - REQUIRED: Set up isolated workspace before starting
- **ai-dev-harness:writing-plans** - Creates the plan this skill executes
- **ai-dev-harness:requesting-code-review** - Code review template for reviewer subagents
- **ai-dev-harness:finishing-a-development-branch** - Complete development after all tasks

**Subagents should use:**
- **ai-dev-harness:test-driven-development** - Subagents follow TDD for each task

**Alternative workflow:**
- **ai-dev-harness:executing-plans** - Use for parallel session instead of same-session execution
